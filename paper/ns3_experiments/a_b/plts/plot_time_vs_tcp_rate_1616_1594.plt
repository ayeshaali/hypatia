...
# Output
set output "pdf/time_vs_tcp_rate_1616_to_1594.pdf"
...
plot    "../data/starlink_550_isls_1616_to_1594_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "NewReno" w steps ls 1, \
        "../data/starlink_550_isls_1616_to_1594_with_TcpVegas_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Vegas" w steps ls 2, \
        "../data/starlink_550_isls_1616_to_1594_with_TcpBbr_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Bbr" w steps ls 3, \
        "../data/starlink_550_isls_1616_to_1594_with_TcpWestwood_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Westwood" w steps ls 4, \
        "../data/starlink_550_isls_1616_to_1594_with_TcpCubic_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Cubic" w steps ls 5, \
        "../data/starlink_550_isls_1616_to_1594_with_TcpHybla_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Hybla" w steps ls 6, \
